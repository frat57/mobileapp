...
public class Trend extends AppCompatActivity implements HaberlerAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> myAdapter = new ArrayAdapter<String>(Trend.this, android.R.layout.simple_list_item_1, names);
        ...
        if(jsonString !=  null ){
            try {
                ...
                for(int i=0; i< array.length(); i++) {
                    ...
                    if(  object.getString("type").equals("gundem")) {
